...
class ProjectController extends Controller
{
     ...
     * by providing --requests, we indicate that we wanted a seperate class for storing and updating projects
     */
    ...
    public function store(StoreProjectRequest $request)
    {
        ...
        Project::create($data);
        return to_route('project.index')->with('success', 'Successfully added new project!');
        //3.17.07
    }
