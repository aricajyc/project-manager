                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <table className="w-full text-sm ext-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    ...
                                    {projects.data.map((project) => (
                                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={project.id}>
                                            ...
                                            <td className="px-3 py-2 place-content-center">
                                                <img src={project.image_path} alt="" style={{ width: 60 }}/> {/*PROJECT IMAGE PATH*/}  
                                            </td>
                                            ...
                                            <td className="px-3 py-2 text-center">
                                                <span className={
                                                    ...
                                                    {PROJECT_STATUS_TEXT_MAP[project.status]} {/*PROJECT STATUS*/}
                                                </span>
                                                
                                            </td>
                                            <td className="px-3 py-2 text-nowrap text-center">
                                                {project.created_at} {/*PROJECT CREATED AT*/}
                                            </td>
                                            <td className="px-3 py-2 text-nowrap text-center">
                                                {project.due_date} {/*PROJECT DUE DATE*/}
                                            </td>
                                            <td className="px-3 py-2 text-center">
                                                {project.createdBy.name} {/*PROJECT CREATED BY*/}
                                            </td>
                                            <td className="px-3 py-2 text-center">
